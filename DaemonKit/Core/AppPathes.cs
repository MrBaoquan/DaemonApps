...
class AppPathes
{
    ...
    public static string ConfigDir_BackUp
    {
        get => Path.Combine(AppRoot, ".cache");
    }
    ...
    {
        get => Path.Combine(AppRoot, ".cache/treeview.xml");
    }
    ...
    {
        get => Path.Combine(AppRoot, ".cache/extension.xml");
    }
    ...
    {
        get => Path.Combine(AppRoot, ".cache/settings.xml");
    }
    ...
    {
        get =>
            System.IO.Path.Combine(System.IO.Path.GetDirectoryName(ExecutorPath), "Applications");
    }
