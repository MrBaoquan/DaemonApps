...
{
    // Note: ScheduleTriggerType, ScheduleTaskAction, ScheduleTaskConfig, and ScheduleTaskContext
    // have been moved to DaemonKit.Models.ScheduleTaskModels for better architecture.
    // This file imports them from there.
